...
var registry = {
  ...
  'native': 'https://github.com/Sable/ostrich-native-compiler.git'
}
  ...
  function autocomplete (dependency) {
    function processDescription (description) {
      if (description === null) {
        ...
        if (description.type === 'compiler') {
          let errors = []
          description.commands.forEach((c, i) => {
            let execPath
            ...
            if (execPath === null) {
              errors.push("Could not find executable '" + (c['executable-name'] || c['executable-path']) + "' in command #" + i)
            } else {
