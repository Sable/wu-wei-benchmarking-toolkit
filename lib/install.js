      ...
      if (description === null) {
        ...
        if (dependency.destination) {
          if (!dependency['short-name']) {
            ...
            return Promise.reject(new Error('Inconsistent short-name between artifact destination ' + dependency.destination.file + ' and asked short-name ' + dependency['short-name']))
          }
        }
