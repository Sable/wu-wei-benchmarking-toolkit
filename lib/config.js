...
exports.genBuildConfigurations = function (config, options) {
  ...
  function resolveBuildConfig (config, b, i, c, cb) {
    ...
    buildConfig.implementation.dependencies = exports.flattenArray(buildConfig.implementation.dependencies)
...
exports.genRunConfigurations = function (config, parsed) {}
